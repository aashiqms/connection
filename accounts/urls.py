...
from . import views
from accounts.views import ProfileCreateView, ProfileUpdateView, ProfileDeleteView, ProfileDetailView, ProfileListView, ProfilePage
...
urlpatterns = [
    ...
    path('userprofile/', ProfilePage.as_view(), name='profile_page')
